// Source: https://github.com/wezterm/wezterm/blob/main/wezterm-escape-parser/src/osc.rs
// Note: Originally linked as termwiz/src/escape/osc.rs, moved to wezterm-escape-parser/src/osc.rs
